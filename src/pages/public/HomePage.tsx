      ...
      <section className="relative w-full bg-neutral-950">
        ...
        >
          <div className="max-w-3xl mx-auto text-center space-y-6 px-4">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/25 border border-emerald-500/40 text-emerald-300 text-xs sm:text-sm font-semibold tracking-wide backdrop-blur-md shadow-sm">
              <Shield className="w-4 h-4 text-emerald-400" /> Direct Farm Network
            </div>
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-black text-white tracking-tight leading-tight drop-shadow-lg">
              Transparent Pricing.<br />
              <span className="text-emerald-400">Zero Middlemen.</span>
            </h2>
            <p className="text-base sm:text-lg text-neutral-100 max-w-2xl mx-auto leading-relaxed drop-shadow-md">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
              <Link
                to="/market"
                className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold shadow-lg shadow-emerald-950/60 transition-all inline-flex items-center justify-center gap-2 active:scale-95 cursor-pointer pointer-events-auto"
              >
                Explore Market <ArrowRight className="w-5 h-5" />
              </Link>
              <Link
                to="/register?role=farmer"
                className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-white/15 hover:bg-white/25 text-white font-bold border border-white/30 backdrop-blur-md transition-all inline-flex items-center justify-center gap-2 active:scale-95 cursor-pointer pointer-events-auto"
              >
                Sell Your Harvest
              </Link>
            </div>
            <div className="pt-6 mt-4 grid grid-cols-3 gap-6 max-w-xl mx-auto border-t border-white/20 text-white">
              <div>
                <div className="text-2xl sm:text-3xl font-extrabold text-white">100%</div>
                <div className="text-xs sm:text-sm text-neutral-300 mt-1 font-medium">Direct Farm Gate</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-extrabold text-emerald-400">&#8377;0</div>
                <div className="text-xs sm:text-sm text-neutral-300 mt-1 font-medium">Broker Commissions</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-extrabold text-white">Verified</div>
                <div className="text-xs sm:text-sm text-neutral-300 mt-1 font-medium">Farms & Quality</div>
              </div>
            </div>
          </div>
        </ScrollExpand>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-4">
            {MARKET_PULSE.map((item, i) => {
              ...
              return (
                <div key={item.name} className={`bg-white rounded-2xl border border-neutral-100 p-3 sm:p-5 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 ${pulseSection.inView ? `animate-scale-in ${delays[i] || ''}` : 'opacity-0'}`}>
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h3 className="font-bold text-neutral-900 text-sm sm:text-lg leading-tight">{item.name}</h3>
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      <span className="text-[10px] sm:text-xs text-neutral-500">Farm Gate Price</span>
                      <span className="text-sm sm:text-xl font-extrabold text-primary">&#8377;{item.farmerPrice}/{item.unit}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-[10px] sm:text-xs text-neutral-500">Mandi Benchmark</span>
                      <span className="text-xs sm:text-sm font-semibold text-neutral-400 line-through">&#8377;{item.mandiPrice}/{item.unit}</span>
                    </div>
                  </div>
                  <div className="mt-4 pt-4 border-t border-neutral-50 flex items-center justify-between">
                    <div className="flex items-center gap-1.5 bg-green-50 text-green-700 text-xs font-bold px-1.5 py-0.5 sm:px-2.5 sm:py-1 text-[9px] sm:text-xs rounded-full">
                      <TrendingDown className="w-3 h-3" /> Save &#8377;{saving}
                    </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div className={`relative ${farmerSection.inView ? 'animate-scale-in' : 'opacity-0'}`}>
            <div className="relative rounded-3xl overflow-hidden aspect-[4/3] shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white rounded-2xl p-4 shadow-xl border border-neutral-100">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`relative ${buyerSection.inView ? 'animate-scale-in delay-200' : 'opacity-0'}`}>
            <div className="relative rounded-3xl overflow-hidden aspect-[4/3] shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-neutral-900 rounded-2xl p-4 border border-neutral-800 shadow-xl">
